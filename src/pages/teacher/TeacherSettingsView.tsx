...
export function TeacherSettingsView() {
  ...
  const [passwords, setPasswords] =
    useState<ChangePasswordPayload>(emptyPasswordForm);
    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-6">
      ...
      <Card>
        <CardHeader className="border-b">
          ...
          <CardDescription>
            Update the information shown on your teacher account.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="border-b">
          ...
          <CardDescription>
            Theme changes are applied immediately and saved on this device.
          </CardDescription>
        </CardHeader>
        <CardContent>
