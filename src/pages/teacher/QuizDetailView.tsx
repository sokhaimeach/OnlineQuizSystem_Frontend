...
export function QuizDetailView() {
  ...
  const saveQuiz = (payload: UpdateQuizPayload) => {
    updateQuiz.mutate(
      { quizId, payload },
      { onSuccess: () => setEditingQuiz(false) },
    );
  };
  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              ...
              {quiz.questions.length === 1 ? "question" : "questions"} in this
              quiz.
            </p>
          </div>
        </div>
          ...
          <QuestionBuilder
            ...
            error={
              addQuestions.isError
                ? mutationError(
                    addQuestions.error,
                    "The questions could not be added.",
                  )
                : undefined
            }
      ...
      <EditQuizDialog
        ...
        error={
          updateQuiz.isError
            ? mutationError(updateQuiz.error, "The quiz could not be updated.")
            : undefined
        }
      ...
      <DeleteQuizDialog
        ...
        error={
          deleteQuiz.isError
            ? mutationError(deleteQuiz.error, "The quiz could not be deleted.")
            : undefined
        }
